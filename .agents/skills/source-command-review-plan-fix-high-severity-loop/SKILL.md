---
name: "source-command-review-plan-fix-high-severity-loop"
description: "Migrated source command `review-plan-fix-high-severity-loop`"
---

# source-command-review-plan-fix-high-severity-loop

Use this skill when the user asks to run the migrated source command `review-plan-fix-high-severity-loop`.
