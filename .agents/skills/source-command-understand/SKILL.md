---
name: "source-command-understand"
description: "Migrated source command `understand`"
---

# source-command-understand

Use this skill when the user asks to run the migrated source command `understand`.
