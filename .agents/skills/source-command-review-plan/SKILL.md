---
name: "source-command-review-plan"
description: "Migrated source command `review-plan`"
---

# source-command-review-plan

Use this skill when the user asks to run the migrated source command `review-plan`.
