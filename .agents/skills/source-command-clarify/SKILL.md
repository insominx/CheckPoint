---
name: "source-command-clarify"
description: "Migrated source command `clarify`"
---

# source-command-clarify

Use this skill when the user asks to run the migrated source command `clarify`.
