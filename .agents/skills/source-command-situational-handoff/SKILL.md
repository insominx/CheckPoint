---
name: "source-command-situational-handoff"
description: "Migrated source command `situational-handoff`"
---

# source-command-situational-handoff

Use this skill when the user asks to run the migrated source command `situational-handoff`.
