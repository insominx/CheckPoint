---
name: "source-command-situational-mine-git-history"
description: "Migrated source command `situational-mine-git-history`"
---

# source-command-situational-mine-git-history

Use this skill when the user asks to run the migrated source command `situational-mine-git-history`.
