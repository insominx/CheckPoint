---
name: "source-command-integrate-docs-and-clean-scratch"
description: "Migrated source command `integrate-docs-and-clean-scratch`"
---

# source-command-integrate-docs-and-clean-scratch

Use this skill when the user asks to run the migrated source command `integrate-docs-and-clean-scratch`.
